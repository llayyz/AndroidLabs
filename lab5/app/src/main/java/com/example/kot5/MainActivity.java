...
public class MainActivity extends AppCompatActivity {
    ...
    void createViewPagerAndTabLayout()
    {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Fragment Show"));
        tabLayout.addTab(tabLayout.newTab().setText("Fragment Add"));
        tabLayout.addTab(tabLayout.newTab().setText("Fragment Delete"));
        tabLayout.addTab(tabLayout.newTab().setText("Fragment Update"));
